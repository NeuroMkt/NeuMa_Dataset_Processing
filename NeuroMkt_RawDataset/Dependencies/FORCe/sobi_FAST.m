...
%**************************************************************************
%
% Note: This is a modified version of the SOBI algorithm that has been
% optimised for speed during its use by the FORCe algorithm. Warning, be
% careful if you want to use this algorithm for other purposes, it may not
% work reliably when not used for the purpose it has been modified for.
%
